...
job_posting_age = '3'  # all, 1, 3, 7, 14 (these are days)
...
job_posting_distance = '100'  # default 5, 10, 15, 25, 50, 100 (these are miles)

# change these to your information
account_email = ''  # your indeed email
account_password = ''  # your indeed password
job_titles = ['DevOps']  # separate job titles must be in quotations separated by a comma
job_location = 'Remote'  # job zip
...
apply_sponsorship = 'yes'  # yes, no -- will you need work sponsorship
...
apply_city='Silver Spring'
apply_state='MD'
apply_country='United States'
apply_address='13920 Castle Blvd'
apply_postalcode='20904'
apply_phone='2024809508'
apply_hear='Indeed'
